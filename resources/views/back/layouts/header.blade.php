    ...
    <div class='quick-area'>
        ...
        <div class='pull-right'>
            <ul class="info-menu right-links list-inline list-unstyled">
                        ...
                        <li class="list">
                            ...
                            <ul class="dropdown-menu-list list-unstyled ps-scrollbar">
                                <li class="unread status-available">
                                    <a href="javascript:;">
                                        <div class="user-img">
                                            <img src="{{asset('public/back/data/profile/avatar-1.png')}}" alt="user-image" class="img-circle img-inline">
                                        </div>
                                        <div>
                                            <span class="name">
                                ...
                                <li class=" status-away">
                                    <a href="javascript:;">
                                        <div class="user-img">
                                            <img src="{{asset('public/back/data/profile/avatar-2.png')}}" alt="user-image" class="img-circle img-inline">
                                        </div>
                                        <div>
                                            <span class="name">
                                ...
                                <li class=" status-busy">
                                    <a href="javascript:;">
                                        <div class="user-img">
                                            <img src="{{asset('public/back/data/profile/avatar-3.png')}}" alt="user-image" class="img-circle img-inline">
                                        </div>
                                        <div>
                                            <span class="name">
                                ...
                                <li class=" status-offline">
                                    <a href="javascript:;">
                                        <div class="user-img">
                                            <img src="{{asset('public/back/data/profile/avatar-4.png')}}" alt="user-image" class="img-circle img-inline">
                                        </div>
                                        <div>
                                            <span class="name">
                                ...
                                <li class=" status-offline">
                                    <a href="javascript:;">
                                        <div class="user-img">
                                            <img src="{{asset('public/back/data/profile/avatar-5.png')}}" alt="user-image" class="img-circle img-inline">
                                        </div>
                                        <div>
                                            <span class="name">
                ...
                <li class="profile">
                    <a href="#" data-toggle="dropdown" class="toggle">
                        <img src="{{asset('public/back/data/profile/profile.jpg')}}" alt="user-image" class="img-circle img-inline">
